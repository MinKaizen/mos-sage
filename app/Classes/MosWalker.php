...
class MosWalker extends Walker_Nav_Menu {
    ...
    protected $class_names = [
        ...
        'submenu_item_link' => 'Submenu_Item_Link',
    ];
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
        ...
        $classes = array_map( function( $class_name ) use ($depth) {
            ...
            return str_replace( $wp_default_class_name, $new_class_name, $class_name );
        }, $classes );
        ...
        $item_class = $depth == 0 ? $this->class_names['menu_item_link'] : $this->class_names['submenu_item_link'];
        $item_class_name = $item_class ? " class='$item_class'" : '';

		$item_output  = $args->before;
		$item_output .= '<a' . $item_class_name . $attributes . '>';
